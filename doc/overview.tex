...
For instance, you may arrive at a different number of MPI processes per node (twelve in our case) depending on the cores available per machine.
Other differences may include how the call to MPI looks like (\texttt{mpirun} vs.\ \texttt{srun} vs.\ \texttt{mpiexec.hydra} vs.\ \ldots) and how exactly you need to provide binding/mapping information.
